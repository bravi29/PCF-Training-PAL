...
namespace PalTrackerTests
{
    public class InMemoryTimeEntryRepositoryTest
    {
        ...
        public void Create()
        {
            TimeEntry expected = new TimeEntry(1, 222, 333, new DateTime(2008, 08, 01, 12, 00, 01), 24);

            TimeEntry created = _repository.Create(new TimeEntry(222, 333, new DateTime(2008, 08, 01, 12, 00, 01), 24));
